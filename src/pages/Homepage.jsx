  ...
  return (
    <MarketingLayout>
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.08fr)_390px]">
        <div className="surface-panel-strong px-6 py-8 sm:px-8 sm:py-10 reveal-up">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            <Link to="/signup" className="primary-action" data-testid="home-primary-cta">
              Start free
        ...
        <aside className="surface-panel p-6 reveal-up" style={{ animationDelay: "90ms" }}>
          <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-ink-400">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-3">
          {featuredResources.map((article) => (
            <Link
              ...
              className="section-card block p-5 transition hover:-translate-y-0.5"
            >
              <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-ink-400">

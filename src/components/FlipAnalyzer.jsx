...
// Reusable Input component for this calculator
...
const FlipAnalyzer = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-xl font-semibold text-brand-gray-800 mb-6 border-b pb-4">Fix & Flip Deal Analyzer</h3>
                ...
                <div className="bg-brand-gray-50 p-6 rounded-lg">
                    ...
                    <div className="mt-8 border-t pt-4 space-y-3">
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="font-bold">${calculations.totalCashNeeded.toLocaleString()}</span>
                        </div>

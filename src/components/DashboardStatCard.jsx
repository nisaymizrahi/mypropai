...
const DashboardStatCard = ({
  ...
  return (
    <div className={`rounded-[24px] border p-5 shadow-[0_16px_40px_rgba(28,23,19,0.06)] ${palette.shell}`}>
      ...
      <p className="mt-5 font-display text-[2.4rem] leading-none text-ink-900">{value}</p>
